...
INSERT INTO `type_request` VALUES (1,'Solicitud de Vacaciones','9025824561','Genera tu solicitud de Vacaciones con VIAPP',0),(2,'Solicitud de Salida Temprana Laboral','1736904841','Genera tu solicitud de Salida Temprana Laboral con VIAPP',0),(3,'Solicitud de Entrada Tardía','2272543022','Genera tu solicitud de Entrada Tardía con VIAPP',0),(4,'Solicitud de Equipos Tecnológicos','0161381197','Genera tu solicitud de Equipos Tecnológicos con VIAPP',0),(5,'Solicitud de Modificación de Hora de Almuerzo','2545597407','Genera tu solicitud de Modificación de Hora de Almuerzo con VIAPP',0),(6,'Solicitud de Acceso a Puertas','8965255865','Genera tu solicitud de Acceso a Puertas con VIAPP',1),(7,'Solicitud de Uso del Gimnasio','5578807752','Genera tu solicitud de Uso del Gimnasio con VIAPP',0),(8,'Solicitud de Formación','6790843990','Genera tu solicitud de Formación con VIAPP',0),(9,'Solicitud de Teletrabajo','1383620075','Genera tu solicitud de Teletrabajo con VIAPP',0),(10,'Solicitud de Licencia sin Sueldo','3704053200','Genera tu solicitud de Licencia sin Sueldo con VIAPP',1),(11,'Solicitud de Movilización','9196891642','Genera tu solicitud de Movilización con VIAPP',0),(12,'Solicitud de Certificado Laboral','1616858044','Genera tu solicitud de Certificado Laboral con VIAPP',0),(13,'Solicitudes Varias','4179005305','Genera tus solicitudes varias con VIAPP',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla de usuarios tegistrados en el sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (4,'Alex Alberto','Ramirez Abarca','alexraab08@gmail.com','aramireza','$2a$10$9Qpe1RaCZDU0lG1Mjy/HweR49vUs7SoghjllZ1M8EyLy.lsx2eDKa',1,'0932144165','https://ui-avatars.com/api/?name=Alex Alberto+Ramirez Abarca&background=FE6936&color=ffffff&length=2&size=200','0984196793','2000-06-08',1,'2024-01-26 14:39:10',NULL,NULL,4,1);
...
SET message = "no existe una opcion con ese parametro";
	...
	CASE(UPPER(_option))
		...
		WHEN 'UPDATE' THEN 
			UPDATE type_request SET status_request = _status_request where id = _request_type_id;
            SELECT _request_type_id as id;
		WHEN 'FIND_USER' THEN 
...
-- Dump completed on 2024-03-01 21:09:02
